...
Counterpart path: ai-workspace-kit/.planning/cross-repo/inbox/REQ-20260507-ai-tools-to-ai-workspace-kit-review-packet-standard.md
...
Status: proposed
Severity: medium
Requested by phase/gate: fixture
Boundary classification: interop contract

## Need

Stable review packet semantics.
