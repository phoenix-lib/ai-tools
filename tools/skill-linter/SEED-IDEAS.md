...
external tool, later kit integration candidate

## Purpose

Checks skills as maintainable project artifacts.

## When To Use

When adding/updating skills, during contract drift review, and before publishing shared skills.
...
Parse SKILL.md; check trigger conditions, verification policy, referenced files, tool assumptions, generic wording, and conflicts with AGENTS.md.
