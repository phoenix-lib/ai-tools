...
Finds tests that pass while important behavior is untested or over-mocked.

## When To Use

Before marking phases verified, after regressions, and when adding generated tests.
...
Analyze tests for assertions, mocks, state transitions, error paths, domain contract coverage, and behavior-to-UI binding.
