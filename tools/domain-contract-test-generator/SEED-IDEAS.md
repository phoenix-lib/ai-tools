...
external project/domain tool

## Purpose

Generates behavior-level tests from domain contracts instead of shallow HTML or snapshot checks.

## When To Use

Before implementation plans for domain-heavy work and after bugs caused by shallow tests.
...
Read domain contract/spec; generate state transition tests, adapter binding tests, and UI-to-domain proof checklist; keep generated tests review-only until accepted.
