...
internal spec plus external registry candidate

## Purpose

Documents when each tool should run, required inputs, outputs, blockers, and automation boundaries.

## When To Use

Before adding many optional tools; every time a new tool is adopted into a workflow.
...
TOOLING-PLAYBOOK.md format; per-tool usage contract; phase mapping; safety rules; review packet integration guidance.
